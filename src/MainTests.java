...
public class MainTests {
  ...
  public static void main(String[] args) throws IOException {
    ...
    String pathName = "./images_etudiants/originale.jpg";
    ...
    for (int i = 0; i < couleurs.length; i++) {
      ...
      String imageName = splittedPath[splittedPath.length - 1].split("\\.")[0] + "_copie_";
      BufferedImage img3 = CluteriseurDeCouleur.calculerImage(new String[]{String.valueOf(couleurs[i]),pathName, outFolder + imageName + couleurs[i] + ".png", String.valueOf(true)});
      ImageIO.write(img2, "png", new java.io.File(outFolder + imageName + couleurs[i] + "_" + tolerances[i] + ".png"));
      ImageIO.write(img3, "png", new java.io.File(outFolder + imageName + couleurs[i] +".png"));
